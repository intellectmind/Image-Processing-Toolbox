...
class SplitModule:
    ...
    def create_ui(self):
        ...
        self.count_label = tb.Label(row1, text=f'{self.split_count.get()} 张', width=10)
        self.count_label.pack(side=LEFT)
        self.split_count.trace_add('write', lambda *_: self.count_label.config(text=f'{self.split_count.get()} 张'))
    ...
    def save_preset(self):
        save_module_preset(self.preset_module_name, self.get_preset_data())
